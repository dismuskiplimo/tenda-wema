<div class="modal fade" id="review-user-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-body">
			<form action="{{ route('user.reviews.show', ['username' => $user->username]) }}" method="POST" class="">
				@csrf
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<button type="submit" class="button button-green submit">REVIEW {{ $user->fname }}</button>
					</div>
				</div>
			</form>
		</div>
